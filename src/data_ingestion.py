...
def save_data(train_data:pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    """Saves the train and test dataset"""
    try:
...
def main():
    try:
        test_size = 0.3
        data_path = 'https://raw.githubusercontent.com/thakkartulsi/MLOps-End-to-End-ML-Pipeline/refs/heads/main/experiments/spam.csv'
